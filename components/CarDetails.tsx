                            ...
                            >
                                ...
                                max-h-[90vh] overflow-y-auto transform rounded-2xl
                                 ...
                                 flex flex-col gap-5 p-6">
                                    <button type='button' className='absolute top-2 right-2 z-10
                                    ...
                                    <div className='flex-1 flex flex-col gap-3'>
                                        <div className='relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg'>
                                            <Image src={`/car_imgs/${Math.floor(Math.random() * 10) + 1}.jpg`} alt="car model" fill priority className='object-cover' />
                                        </div>
